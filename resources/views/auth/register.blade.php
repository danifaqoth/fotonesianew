                            ...
                            <div class="panel-body">
                                <form class="form-horizontal" role="form" method="POST" action="{{ route('register.vendor') }}">
                                    ...
                                    <div class="form-group{{ $errors->has('name-vendor') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-6">
                                            <input id="name-vendor" type="text" class="form-control" name="name_vendor" value="{{ old('name-vendor') }}" required autofocus>
                                    ...
                                    <div class="form-group{{ $errors->has('kota-vendor') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select class="form-control" value="{{ old('kota-vendor') }}" name="kota">
